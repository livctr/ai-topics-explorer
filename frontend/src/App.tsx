      ...
      <header>
        ...
        <div className="header-description">
          <p>
            ...
            <a href="https://www.semanticscholar.org/product/api">Semantic Scholar API</a>, accessed on{" "}
            {date_string}. The topic taxonomy on the left is the result of
            asking{" "}
            <a href="https://platform.openai.com/docs/models/gpt-4.1-mini">
              gpt-4.1-mini
            </a>{" "}
          ...
          <p>
            ...
            via Tavily search + LLM. They are not 100% accurate and can refer to
            the wrong person - especially same-name researchers.
          </p>
          <p>
            (3) The criteria for paper inclusion is being in the top 50 by citations per month, for 
            the past 12 months (total less than 600 papers). The criteria for author inclusion is being an author
            on one of those papers and having a non-zero H-index.
          </p>
        </div>
      </header>
